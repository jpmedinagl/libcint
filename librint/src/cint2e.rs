...
pub unsafe extern "C" fn int2e_sph(
    ...
    CINTinit_int2e_EnvVars(&mut envs as *mut CINTEnvVars, ng.as_mut_ptr(), shls.as_mut_ptr(), atm.as_mut_ptr(), atm.len(), natm, bas.as_mut_ptr(), bas.len(), nbas, env.as_mut_ptr(), env.len());
    envs
